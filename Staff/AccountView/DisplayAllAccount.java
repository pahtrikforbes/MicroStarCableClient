...
import utils.CustomizedException;
	...
	public class DisplayAllAccount extends javax.swing.JInternalFrame {
...
//	        Grab the returned array list and put it into a variable of type Arraylist
	  				...
	  				System.out.println("List successfully retrieved!");
	  				 Object rowData[] = new Object[2];
	  			        for (int i =0; i < displayList.size(); i++ ){
	  			            ...
	  			            rowData[1] = displayList.get(i).getUser();
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(DisplayAllAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new DisplayAllAccount().setVisible(true);
	            }
	        });
	    }
