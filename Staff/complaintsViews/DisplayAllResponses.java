 ...
 * @author Ishi
 */
public class DisplayAllResponses extends javax.swing.JInternalFrame {
...
//        Grab the returned array list and put it into a variable of type Arraylist
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayAllResponses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplayAllResponses().setVisible(true);
            }
        });
    }
